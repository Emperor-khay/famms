              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="{{ asset('{{ Auth::user()->profile_photo_url }}') }}" alt="{{ Auth::user()->name }}">
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                        <form action="{{ route('profile.show') }}" method="GET">
                            @csrf
                            <input type="submit" value="Profile" class="mb-1 preview-subject btn">
                        </form>
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <input type="submit" value="Logout" class="mb-1 preview-subject btn">
                        </form>

                      {{-- <p class="mb-1 preview-subject"><a href="{{ route('logout') }}">Log out</a></p> --}}
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
