                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                        <form action="{{ route('profile.show') }}" method="GET">
                            @csrf
                            <input type="submit" value="Profile" class="preview-subject mb-1 btn">
                        </form>
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <input type="submit" value="Logout" class="preview-subject mb-1 btn">
                        </form>

                      {{-- <p class="preview-subject mb-1"><a href="{{ route('logout') }}">Log out</a></p> --}}
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
