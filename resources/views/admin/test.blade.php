...
<style type="text/css">
    ...
    .text-muted a {
     ...
     /* Mobile-specific print button style */
     .print-button {
        display: none;
        position: fixed;
        bottom: 20px;
                ...
                <div class="card my-5">
                    <div class="card-body">
                        <div class="invoice-title">
                            <h4 class="float-end font-size-15 d-grid">Invoice #000{{ $order->id }}
                                {{-- payment status for mobile --}}
                                <span class="badge bg-success font-size-12 ms-2 p-2 d-md-none">{{ $order->payment_status }}</span>
                                {{-- print button and payment status for big screens  --}}
                                <div class="d-print-none print-container">
                                    <span class="badge bg-success font-size-12 ms-2 p-2">{{ $order->payment_status }}</span>
                                    <button class="btn btn-primary" onclick="window.print()">Print</button>
                                </div>
                            </h4>
                            <div class="mb-4">
                                <h2 class="mb-1 text-muted w-sm-100 d-sm-flex">FAMMS</h2>
                            </div>
