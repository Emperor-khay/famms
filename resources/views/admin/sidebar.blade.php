      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ route('product_form') }}">Add Products</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{ route('show_product') }}">View Products</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item menu-items">
