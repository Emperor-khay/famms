<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="address" type="text" class="block w-full mt-1" wire:model="state.address" required autocomplete="address" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="phone" type="text" class="block w-full mt-1" wire:model="state.phone" required autocomplete="phone" />
