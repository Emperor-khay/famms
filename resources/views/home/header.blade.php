...
<header class="header_section">
    <div class="container">
       <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href={{ route('dashboard') }}><img width="250" src="{{ asset('home/images/logo.png') }}" alt="#" /></a>
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <span class=""> </span>
          </button>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav">
                <li class="nav-item @if (Route::is('index')) active @endif @if (Route::is('dashboard')) active @endif">
               ...
               {{-- <li class="nav-item dropdown">
                ...
                @auth
                <li class="nav-item @if (Route::is('show_cart')) active @endif">
                ...
                {{-- <li class="nav-item">
                    ...
                    <a href="{{ route('profile.show') }}" class="inline-block nav-link float-end">{{ Auth::user()->name }}</a>
                </li> --}}
                <li class="nav-item @if (Route::is('show_order')) active @endif">
                    <a class="nav-link" href="{{ route('show_order') }}">Orders</a>
                 </li>
